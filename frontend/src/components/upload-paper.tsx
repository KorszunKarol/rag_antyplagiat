              ...
              {isUploading ? (
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full max-w-md mb-2">
                    <Progress value={uploadProgress} className="h-2" indicatorClassName="bg-slate-700" />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
                    ...
                    <div className="space-y-3 mt-3">
                      <div className="flex items-center space-x-2">
                        <Switch id="web-sources" defaultChecked />
                        <Label htmlFor="web-sources">Web Sources</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch id="academic-journals" defaultChecked />
                        <Label htmlFor="academic-journals">Academic Journals</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch id="books" defaultChecked />
                        <Label htmlFor="books">Books and Publications</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch id="private-database" />
                        <Label htmlFor="private-database">Private Institution Database</Label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
                    ...
                    <div className="space-y-3 mt-3">
                      <div className="flex items-center space-x-2">
                        <Switch id="check-citations" defaultChecked />
                        <Label htmlFor="check-citations">Exclude cited content</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch id="check-quotes" defaultChecked />
                        <Label htmlFor="check-quotes">Exclude quoted content</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Switch id="ai-detection" />
                        <Label htmlFor="ai-detection">Check for AI-generated content</Label>
                      </div>
                    </div>
                  </div>
                </div>
